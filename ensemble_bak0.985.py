...
# ws = list()
    ...
    #     windows2 = 8
    #     ws.append( (windows1, windows2) )
    # for windows2 in [3, 5, 8]:
    #     windows1 = 8
    #     ws.append((windows1, windows2))
    # for windows1, windows2 in ws:
    ...
    #                                 name='conditiondensemodel_w{}_w{}.h5'.format(windows1,windows2))
    #     model.load_weights()
    ...
    #                                term_embed_matrix=term_embed_matrix,
    #                                name='conditionsemodel_w{}_w{}.h5'.format(windows1,windows2))
    #     model.load_weights()
    #     y = model.predict([x, xe, xterm, xe_term, xfeat, xtopic])
    #     ys.append(y)
    #     del model
    ...
    # for windows1, windows2 in ws[:4]:
    #     model = ConditionDenseMAModel(model_conf, char_embed_matrix=char_embed_matrix,
    #                                   term_embed_matrix=term_embed_matrix,
    #                                   name='conditiondensemamodel_w{}_w{}.h5'.format(windows1,windows2))
    #     model.load_weights()
    #     y = model.predict([x, xe, xterm, xe_term, xfeat, xtopic])
    #     ys.append(y)
    #     del model
    #     print('condition dense ma model done.')
        ...
        #                            term_embed_matrix=term_embed_matrix,
        #                            name='conditionrcnnmodel_w{}_w{}.h5'.format(windows1,windows2))
        # model.load_weights()
        # y = model.predict([x, xe, xterm, xe_term, xfeat, xtopic])
        # ys.append(y)
        # del model
        ...
        #                           term_embed_matrix=term_embed_matrix,
        #                           name='conditionattmodel_w{}_w{}.h5'.format(windows1,windows2))
        # model.load_weights()
        # y = model.predict([x, xe, xterm, xe_term, xfeat, xtopic])
        # ys.append(y)
        # del model
        ...
        #                            term_embed_matrix=term_embed_matrix,
        #                            name='conditionconvmodel_w{}_w{}.h5'.format(windows1,windows2))
        # model.load_weights()
        # y = model.predict([x, xe, xterm, xe_term, xfeat, xtopic])
        # ys.append(y)
        # del model
        ...
        #                             term_embed_matrix=term_embed_matrix,
        #                             name='conditiondpcnnmodel_w{}_w{}.h5'.format(windows1,windows2))
        # model.load_weights()
        # y = model.predict([x, xe, xterm, xe_term, xfeat, xtopic])
        # ys.append(y)
        # del model
        ...
        #                                 term_embed_matrix=term_embed_matrix,
        #                                 name='conditiongatedconvmodel_w{}_w{}.h5'.format(windows1,windows2))
        # model.load_weights()
        # y = model.predict([x, xe, xterm, xe_term, xfeat, xtopic])
        # ys.append(y)
        # del model
        ...
        #                                    term_embed_matrix=term_embed_matrix,
        #                                    name='conditiongateddeepcnnmodel_w{}_w{}.h5'.format(windows1,windows2))
        # model.load_weights()
        # y = model.predict([x, xe, xterm, xe_term, xfeat, xtopic])
        # ys.append(y)
        # del model
    ...
    #     #                       name='hybridsemodel_ftoe_w{}.h5'.format(windows))
    #     # model.load_weights()
    #     # y = model.predict([x, xe, xterm, xe_term, xfeat, xtopic])
    #     # ys.append(y)
    #     # del model
    ...
    #     #                        name='hybridattmodel_ftoe_w{}.h5'.format(windows))
    #     # model.load_weights()
    #     # y = model.predict([x, xe, xterm, xe_term, xfeat, xtopic])
    #     # ys.append(y)
    #     # del model
    ...
    #                             name='hybridconvmodel_ftoe_w{}.h5'.format(windows))
    #     model.load_weights()
    #     y = model.predict([x, xe, xterm, xe_term, xfeat, xtopic])
    #     ys.append(y)
    #     del model
    ...
    #     #                          name='hybriddpcnnmodel_ftoe_w{}.h5'.format(windows))
    #     # model.load_weights()
    #     # y = model.predict([x, xe, xterm, xe_term, xfeat, xtopic])
    #     # ys.append(y)
    #     # del model
    ...
    #     #
    #     # model = HybridGatedDeepCNNModel(model_conf, char_embed_matrix=char_embed_matrix,
    #     #                                 term_embed_matrix=term_embed_matrix,
    #     #                                 name='hybridgateddeepcnnmodel_ftoe_w{}.h5'.format(windows))
    #     # model.load_weights()
    #     # y = model.predict([x, xe, xterm, xe_term, xfeat, xtopic])
    #     # ys.append(y)
    #     # del model
    ...
    #     #                         name='hybridrcnnmodel_ftoe_w{}.h5'.format(windows))
    #     # model.load_weights()
    #     # y = model.predict([x, xe, xterm, xe_term, xfeat, xtopic])
    #     # ys.append(y)
    #     # del model
    ...
    #     #
    #     # model = HybridGatedConvTopicModel(model_conf, char_embed_matrix=char_embed_matrix,
    #     #                                   term_embed_matrix=term_embed_matrix,
    #     #                                   name='hybridgatedconvtopicmodel_ftoe_w{}.h5'.format(windows))
    #     # model.load_weights()
    #     # y = model.predict([x, xe, xterm, xe_term, xfeat, xtopic])
    #     # del model
    #     # ys.append(y)
