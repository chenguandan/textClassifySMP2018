...
class HybridDenseModel(HybridModelBase):
    ...
    def __init__(self, conf, char_embed_matrix=None, term_embed_matrix=None,
                 name='hybriddensemodel.h5', train_embed=False,
                 train_top=True):
        super(HybridDenseModel, self).__init__(conf=conf, char_embed_matrix=char_embed_matrix, term_embed_matrix=term_embed_matrix,
...
if __name__ == '__main__':
    main = HybridDenseMain('hybriddensemodel', HybridDenseModel)
    main.main()