...
class ConditionDenseMAModel(ConditionModelBase):
    ...
    def __init__(self, conf, char_embed_matrix=None, term_embed_matrix=None,
                 name='conditiondensemamodel.h5', train_embed=False,
                 train_top=True):
        super(ConditionDenseMAModel, self).__init__(conf=conf, char_embed_matrix=char_embed_matrix,
...
if __name__ == '__main__':
    main = ConditionMain('conditiondensemamodel', ConditionDenseMAModel)
    main.main()
